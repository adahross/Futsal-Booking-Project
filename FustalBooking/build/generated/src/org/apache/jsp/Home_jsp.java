...
public final class Home_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.sendRedirect(request.getContextPath() + "/sessionterminate.jsp"); 
      ...
      out.write('\n');
      out.write('\n');
      Bean.User memberprofile = null;
      synchronized (session) {
        memberprofile = (Bean.User) _jspx_page_context.getAttribute("memberprofile", PageContext.SESSION_SCOPE);
        if (memberprofile == null){
          memberprofile = new Bean.User();
          _jspx_page_context.setAttribute("memberprofile", memberprofile, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\n");
      out.write("<html>\n");
      ...
      out.write("\t\t\t<!-- Header -->\n");
      out.write("\t\t\t\t");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "headerProfile.jsp", out, false);
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t<!-- Banner -->\n");
      ...
      out.write("\t\t\t\t\t\t\t<p>With this features, each user can view and edit their profile easily.</p>\n");
      out.write("\t\t\t\t\t\t</header>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t<ul class=\"actions\">\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"viewprofile.jsp\" class=\"button\">Click Here</a></li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t<div class=\"content\">\n");
      out.write("\t\t\t\t\t\t<header>\n");
      out.write("\t\t\t\t\t\t\t<h2>BOOK COURT</h2>\n");
      out.write("\t\t\t\t\t\t\t<p>With this features, user can view the availability of the court and book directly.</p>\n");
      out.write("\t\t\t\t\t\t</header>\n");
      out.write("\t\t\t\t\t\t<ul class=\"actions\">\n");
